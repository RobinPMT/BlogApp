...
namespace Blog.Controllers
{
    public class PostsController : Controller
    {
        ...
        {
            var newContext = _context.Posts.Include(p => p.Category);
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            ViewData["CategoryID"] = new SelectList(_context.Categories, "ID", "CategoryName", post.CategoryID);
            return View(post);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,PostTitle,PostContent,PostTeaser,PostImg,ViewCount,CategoryID")] Post post)
        {
            if (id != post.ID)
            {
                return NotFound();
